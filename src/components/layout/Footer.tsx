        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link to="/tools" className="text-sm text-[var(--text-secondary)] hover:text-[var(--brand-text)] hover:translate-x-0.5 inline-block transition-all">
                  全部工具
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-sm text-[var(--text-secondary)] hover:text-[var(--brand-text)] hover:translate-x-0.5 inline-block transition-all">
                  关于我们
                </Link>
              </li>
            </ul>
