    ...
    <div className="max-w-5xl mx-auto px-6 py-12">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-10">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="font-['Syne'] font-bold text-2xl sm:text-3xl text-[var(--text-primary)]">时间戳转换</h1>
        </div>
        <p className="text-[var(--text-secondary)] ml-[52px]">Unix时间戳与日期时间互转，支持秒级和毫秒级</p>
      </motion.div>
      ...
      >
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <p className="text-xs text-[var(--text-faint)] mb-1">当前时间（实时更新）</p>
        ...
        <div className="flex gap-6 mt-4 pt-4 border-t border-[var(--border-color)]">
          <div>
            <span className="text-xs text-[var(--text-faint)]">秒级时间戳：</span>
          ...
          <div>
            <span className="text-xs text-[var(--text-faint)]">毫秒级时间戳：</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }}>
          <div className="flex items-center justify-between mb-2 ml-1">
            <label className="text-sm font-medium text-[var(--text-secondary)]">时间戳 → 日期时间</label>
            {tsToDateResult && (
          ...
          <textarea
            ...
            aria-label="时间戳"
            className="tool-area w-full h-[140px] p-4 text-sm leading-relaxed resize-none outline-none focus:border-[#00d9ff]/30 transition-colors placeholder:text-[var(--text-faint)] font-mono"
          />
          ...
          {tsToDateResult && (
            <div className="tool-area w-full mt-3 p-4 min-h-[60px]">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs text-[var(--text-faint)]">转换结果</span>
              </div>
              <p className="font-mono text-sm text-[var(--text-primary)]">{tsToDateResult}</p>
            </div>
          )}
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
          <div className="flex items-center justify-between mb-2 ml-1">
            <label className="text-sm font-medium text-[var(--text-secondary)]">日期时间 → 时间戳</label>
            {dateToTsResult && (
          ...
          <input
            ...
            aria-label="日期时间"
            className="tool-area w-full h-[48px] px-4 text-sm outline-none focus:border-[#00d9ff]/30 transition-colors placeholder:text-[var(--text-faint)]"
          />
          ...
          {dateToTsResult && (
            <div className="tool-area w-full mt-3 p-4 min-h-[80px]">
              ...
              <pre className="font-mono text-sm text-[var(--text-primary)] whitespace-pre-wrap">{dateToTsResult}</pre>
            </div>
          )}
        </motion.div>
      </div>
