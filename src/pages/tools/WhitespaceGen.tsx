              ...
              {WHITESPACE_CHARS.map((item, index) => (
                <tr
                  ...
                  style={{
                    ...
                    backgroundColor: selectedChars.has(index) ? `${COLOR}14` : undefined,
                  }}
                  onMouseEnter={(e) => { if (!selectedChars.has(index)) (e.currentTarget as HTMLTableRowElement).style.backgroundColor = 'rgba(255,255,255,0.03)'; }}
                  onMouseLeave={(e) => { if (!selectedChars.has(index)) (e.currentTarget as HTMLTableRowElement).style.backgroundColor = selectedChars.has(index) ? `${COLOR}14` : ''; }}
                >
                  <td className="py-3 px-4">
                    <div
                      style={{
                        width: 16, height: 16, borderRadius: 4, transition: 'all 0.15s',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        border: selectedChars.has(index) ? `2px solid ${COLOR}` : '1px solid #444',
                  ...
                  <td className="py-3 px-4 text-right">
                    <button
                      ...
                      style={{
                        ...
                        backgroundColor: copiedIndex === index ? COLOR : 'rgba(255,255,255,0.05)',
                        color: copiedIndex === index ? '#fff' : '#a8b2c1',
                      }}
                      onMouseEnter={(e) => { if (copiedIndex !== index) (e.currentTarget as HTMLButtonElement).style.backgroundColor = 'rgba(255,255,255,0.1)'; }}
                      onMouseLeave={(e) => { if (copiedIndex !== index) (e.currentTarget as HTMLButtonElement).style.backgroundColor = 'rgba(255,255,255,0.05)'; }}
                    >
                  ...
                  <div className="tool-area p-4 font-mono text-sm break-all min-h-[60px] text-[#a8b2c1]">
                    {combinedResult.split('').map((ch, i) => (
                      <span key={i} className="inline-block mx-0.5">
                        <span
                          style={{ backgroundColor: `${COLOR}26`, color: COLOR, padding: '2px 6px', borderRadius: 4, fontSize: 12 }}
                        >
            ...
            {testInput && (
              <div className="space-y-3">
                ...
                {testZeroWidthCount > 0 && (
                  <div style={{ backgroundColor: `${COLOR}1A`, border: `1px solid ${COLOR}33`, borderRadius: 8, padding: '12px', fontSize: 12, color: COLOR }}>
